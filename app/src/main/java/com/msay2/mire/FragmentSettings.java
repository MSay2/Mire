...
public class FragmentSettings extends Fragment implements MenuAnimation
{
	...
	{
		String title = String.format(((MainActivity)getActivity()).getStringSrc(R.string.fragment_settings_update_title), com.msay2.mire.preferences.Preferences.VERSION_NAME);
