package com.msay2.mire.drawable;
...
public class MorphDrawable extends Drawable 
{
    ...
    public static final Property CORNER_RADIUS = AnimUtils.createFloatProperty(new AnimUtils.FloatProp<MorphDrawable>("cornerRadius") 
	{
		@Override
    ...
    public static final Property<MorphDrawable, Integer> COLOR = AnimUtils.createIntProperty(new AnimUtils.IntProp<MorphDrawable>("color") 
	{
		@Override
